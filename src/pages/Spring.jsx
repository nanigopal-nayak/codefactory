...
import springQuestions from "../data/Spring/springQuestion";
import springMCQ from "../data/Spring/springMCQ";
import springCoding from "../data/Spring/springCoding";
...
const Spring = () => {
    ...
    const [visible, setVisible] = useState(springCoding.map(() => false));
    ...
    const nextQuestion = () => {
        ...
        if (currentQ < springMCQ.length - 1) {
    ...
    const filteredCoding = springCoding.filter(
        (item) =>
            ...
            <main className="page-content">
                ...
                {activeTab === "mcq" && !showResult && (
                    <div className="mcq-container">
                        ...
                        <h2>Spring Boot MCQ Test</h2>
                        <p>
                            Question {currentQ + 1} / {springMCQ.length}
                        </p>

                        <div className="mcq-box">
                            <h3>{springMCQ[currentQ].question}</h3>

                            <div className="options">
                                {springMCQ[currentQ].options.map((opt, i) => (
                                    <button
                                        key={i}
                    ...
                    `}
                        ...
                        <div className="mcq-nav">
                            ...
                            <button onClick={nextQuestion}>
                                {currentQ === springMCQ.length - 1 ? "Finish" : "Next"}
                            </button>
                        </div>
                ...
                {activeTab === "mcq" && showResult && (
                    <div className="result-box">
                        ...
                        <h2>
                            Your Score: {calculateScore()} / {springMCQ.length}
                        </h2>
