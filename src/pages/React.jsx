...
import reactQuestions from "../data/React/ReactQuestion";
import reactMCQ from "../data/React/ReactMCQ";
import reactCoding from "../data/React/ReactCoding";
...
const ReactPage = () => {
  ...
  const [visible, setVisible] = useState(reactCoding.map(() => false));
  ...
  const filteredCoding = reactCoding.filter(
    (item) =>
      ...
      <main className="page-content">
        ...
        {activeTab === "mcq" && !showResult && (
          <div className="mcq-container">
            ...
            <h2>React MCQ Test</h2>
            <p>
              Question {currentQ + 1} / {reactMCQ.length}
            </p>

            <div className="mcq-box">
              <h3>{reactMCQ[currentQ].question}</h3>

              <div className="options">
                {reactMCQ[currentQ].options.map((opt, i) => (
                  <button
                    key={i}
            ...
            <div className="mcq-nav">
              ...
              <button onClick={nextQuestion}>
                {currentQ === reactMCQ.length - 1 ? "Finish" : "Next"}
              </button>
            </div>
        ...
        {activeTab === "mcq" && showResult && (
          <div className="result-box">
            ...
            <h2>
              Your Score: {calculateScore()} / {reactMCQ.length}
            </h2>
